namespace MVC5Homework1.Models
{
	public static class RepositoryHelper
	{
		...
		public static vw_CustomerInfoRepository Getvw_CustomerInfoRepository()
		{
			var repository = new vw_CustomerInfoRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static vw_CustomerInfoRepository Getvw_CustomerInfoRepository(IUnitOfWork unitOfWork)
		{
			var repository = new vw_CustomerInfoRepository();
			repository.UnitOfWork = unitOfWork;
			return repository;
